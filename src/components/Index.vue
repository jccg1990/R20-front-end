    ...
    <div>
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><input type="text" placeholder="yyyy-mm-dd" class="form-control" v-model="student.entryDate"/></td>
            ...
            <tbody>
                <tr v-for="student in students" :key="student.studentID">
                    ...
                    <td>{{ student.name }}</td>
                    <td><router-link :to="{name: 'Edit', params: { id: student.studentID }}" class="btn btn-primary">Edit</router-link></td>
                    <td><button class="btn btn-danger"  v-on:click="deleteStudent(student.studentID)">Delete</button></td>
                </tr>
            </tbody>
        </table>
    </div>
