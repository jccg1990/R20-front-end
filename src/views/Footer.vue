    ...
    <div class="mt-2">
        <footer class="page-footer bg-info text-white font-small teal pt-4">
            <div class="container-fluid text-center text-md-left">
                <div class="row">
                    <div class="col-md-6 mt-md-0 mt-3">
                        <h5 class="text-uppercase font-weight-bold">Demo Project</h5>
                        <p>This is a demo from the programming challenge for R20 and KForce</p>
                    </div>
            ...
            <div class="footer-copyright text-center py-3">© 2018 Copyright:
                <a href="https://mdbootstrap.com/education/bootstrap/" class="text-decoration-none">joecastle.com</a>
            </div>
        </footer>
    </div>
